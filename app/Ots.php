    ...
    protected function ots() {
        if (!isset(self::$ots_client)) {
            $config = array(
                ...
                'DebugLogHandler' => env('DEBUG_LOG_HANDLER', null),
                'ConnectionTimeout' => env('CONNECT_ION_TIME_OUT', 5.0),
                'SocketTimeout' => env('SOCKET_TIME_OUT', 5.0),
                'ErrorLogHandler' => env('ERROR_LOG_HANDLER', null)
            );
            if (!$config) {
